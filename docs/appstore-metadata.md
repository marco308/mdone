...
Pick your task list size, plus Shortcuts and Siri fixes.

- Task row size: choose Compact, Standard, or Large in Settings > Appearance. Compact fits more tasks on screen; Standard keeps the familiar look.
